...
namespace Achi.DataAccess.Migrations
{
    ...
    [Migration("20250519133043_orderdetails")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Achi.Models.OrderDetail", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Achi.Models.OrderHeader", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Achi.Models.ShoppingCart", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Achi.Models.OrderDetail", b =>
                {
                    b.HasOne("Achi.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderHeaderID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Achi.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Achi.Models.OrderHeader", b =>
                {
                    b.HasOne("Achi.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Achi.Models.ApplicationUser", b =>
                {
                    b.HasOne("Achi.Models.Company", "Company")
                        .WithMany()
